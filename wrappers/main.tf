module "wrapper" {
  ...
  computed_egress_with_cidr_ipv4                               = try(each.value.computed_egress_with_cidr_ipv4, var.defaults.computed_egress_with_cidr_ipv4, [])
  computed_egress_with_cidr_ipv6                               = try(each.value.computed_egress_with_cidr_ipv6, var.defaults.computed_egress_with_cidr_ipv6, [])
  computed_egress_with_prefix_list_id                          = try(each.value.computed_egress_with_prefix_list_id, var.defaults.computed_egress_with_prefix_list_id, [])
  computed_egress_with_self                                    = try(each.value.computed_egress_with_self, var.defaults.computed_egress_with_self, [])
  computed_egress_with_referenced_security_group_id            = try(each.value.computed_egress_with_referenced_security_group_id, var.defaults.computed_egress_with_referenced_security_group_id, [])
  computed_ingress_rules                                       = try(each.value.computed_ingress_rules, var.defaults.computed_ingress_rules, [])
  computed_ingress_with_cidr_ipv4                              = try(each.value.computed_ingress_with_cidr_ipv4, var.defaults.computed_ingress_with_cidr_ipv4, [])
  computed_ingress_with_cidr_ipv6                              = try(each.value.computed_ingress_with_cidr_ipv6, var.defaults.computed_ingress_with_cidr_ipv6, [])
  computed_ingress_with_prefix_list_id                         = try(each.value.computed_ingress_with_prefix_list_id, var.defaults.computed_ingress_with_prefix_list_id, [])
  computed_ingress_with_self                                   = try(each.value.computed_ingress_with_self, var.defaults.computed_ingress_with_self, [])
  computed_ingress_with_referenced_security_group_id           = try(each.value.computed_ingress_with_referenced_security_group_id, var.defaults.computed_ingress_with_referenced_security_group_id, [])
  ...
  egress_cidr_ipv4                                             = try(each.value.egress_cidr_ipv4, var.defaults.egress_cidr_ipv4, ["0.0.0.0/0"])
  egress_cidr_ipv6                                             = try(each.value.egress_cidr_ipv6, var.defaults.egress_cidr_ipv6, ["::/0"])
  ...
  egress_with_cidr_ipv4                                        = try(each.value.egress_with_cidr_ipv4, var.defaults.egress_with_cidr_ipv4, [])
  egress_with_cidr_ipv6                                        = try(each.value.egress_with_cidr_ipv6, var.defaults.egress_with_cidr_ipv6, [])
  egress_with_prefix_list_id                                   = try(each.value.egress_with_prefix_list_id, var.defaults.egress_with_prefix_list_id, [])
  ...
  ingress_with_cidr_ipv4                                       = try(each.value.ingress_with_cidr_ipv4, var.defaults.ingress_with_cidr_ipv4, [])
  ingress_with_cidr_ipv6                                       = try(each.value.ingress_with_cidr_ipv6, var.defaults.ingress_with_cidr_ipv6, [])
  ingress_with_prefix_list_id                                  = try(each.value.ingress_with_prefix_list_id, var.defaults.ingress_with_prefix_list_id, [])
  ingress_with_self                                            = try(each.value.ingress_with_self, var.defaults.ingress_with_self, [])
  ingress_with_referenced_security_group_id                    = try(each.value.ingress_with_referenced_security_group_id, var.defaults.ingress_with_referenced_security_group_id, [])
  ...
  number_of_computed_egress_with_cidr_ipv4                     = try(each.value.number_of_computed_egress_with_cidr_ipv4, var.defaults.number_of_computed_egress_with_cidr_ipv4, 0)
  number_of_computed_egress_with_cidr_ipv6                     = try(each.value.number_of_computed_egress_with_cidr_ipv6, var.defaults.number_of_computed_egress_with_cidr_ipv6, 0)
  number_of_computed_egress_with_prefix_list_id                = try(each.value.number_of_computed_egress_with_prefix_list_id, var.defaults.number_of_computed_egress_with_prefix_list_id, 0)
  ...
  number_of_computed_egress_with_referenced_security_group_id  = try(each.value.number_of_computed_egress_with_referenced_security_group_id, var.defaults.number_of_computed_egress_with_referenced_security_group_id, 0)
  ...
  number_of_computed_ingress_with_cidr_ipv4                    = try(each.value.number_of_computed_ingress_with_cidr_ipv4, var.defaults.number_of_computed_ingress_with_cidr_ipv4, 0)
  number_of_computed_ingress_with_cidr_ipv6                    = try(each.value.number_of_computed_ingress_with_cidr_ipv6, var.defaults.number_of_computed_ingress_with_cidr_ipv6, 0)
  number_of_computed_ingress_with_prefix_list_id               = try(each.value.number_of_computed_ingress_with_prefix_list_id, var.defaults.number_of_computed_ingress_with_prefix_list_id, 0)
  ...
  number_of_computed_ingress_with_referenced_security_group_id = try(each.value.number_of_computed_ingress_with_referenced_security_group_id, var.defaults.number_of_computed_ingress_with_referenced_security_group_id, 0)
