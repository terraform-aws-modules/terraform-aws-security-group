...
For Terraform 1.3 or later use any version from `v5.0.0` of this module or newer.
...
| [aws_security_group_rule.computed_egress_with_custom_blocks](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/security_group_rule) | resource |
...
| [aws_security_group_rule.computed_ingress_with_custom_blocks](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/security_group_rule) | resource |
...
| [aws_security_group_rule.egress_with_custom_blocks](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/security_group_rule) | resource |
...
| [aws_security_group_rule.ingress_with_custom_blocks](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/security_group_rule) | resource |
...
| <a name="input_computed_egress_with_custom_blocks"></a> [computed\_egress\_with\_custom\_blocks](#input\_computed\_egress\_with\_custom\_blocks) | List of computed egress rules to create with specific cidr\_blocks, prefix\_list\_ids, self, source\_security\_group\_id or ipv6\_cidr\_blocks | <pre>list(object({<br>    description              = optional(string, "Computed Egress Rule")<br>    from_port                = optional(number)<br>    rule                     = optional(string, "_")<br>    to_port                  = optional(number)<br>    protocol                 = optional(string)<br>    cidr_blocks              = optional(list(string))<br>    ipv6_cidr_blocks         = optional(list(string))<br>    prefix_list_ids          = optional(list(string))<br>    self                     = optional(bool)<br>    source_security_group_id = optional(string)<br>  }))</pre> | `[]` | no |
...
| <a name="input_computed_ingress_with_custom_blocks"></a> [computed\_ingress\_with\_custom\_blocks](#input\_computed\_ingress\_with\_custom\_blocks) | List of computed ingress rules to create where cidr\_blocks, prefix\_list\_ids, self, source\_security\_group\_id or ipv6\_cidr\_blocks is defined | <pre>list(object({<br>    description              = optional(string, "Computed Ingress Rule")<br>    from_port                = optional(number)<br>    rule                     = optional(string, "_")<br>    to_port                  = optional(number)<br>    protocol                 = optional(string)<br>    cidr_blocks              = optional(list(string))<br>    ipv6_cidr_blocks         = optional(list(string))<br>    prefix_list_ids          = optional(list(string))<br>    self                     = optional(bool)<br>    source_security_group_id = optional(string)<br>  }))</pre> | `[]` | no |
...
| <a name="input_egress_with_custom_blocks"></a> [egress\_with\_custom\_blocks](#input\_egress\_with\_custom\_blocks) | List of egress rules to create with specific cidr\_blocks, prefix\_list\_ids, self, source\_security\_group\_id or ipv6\_cidr\_blocks | <pre>list(object({<br>    description              = optional(string, "Egress Rule")<br>    from_port                = optional(number)<br>    rule                     = optional(string, "_")<br>    to_port                  = optional(number)<br>    protocol                 = optional(string)<br>    cidr_blocks              = optional(list(string))<br>    ipv6_cidr_blocks         = optional(list(string))<br>    prefix_list_ids          = optional(list(string))<br>    self                     = optional(bool)<br>    source_security_group_id = optional(string)<br>  }))</pre> | `[]` | no |
...
| <a name="input_ingress_with_custom_blocks"></a> [ingress\_with\_custom\_blocks](#input\_ingress\_with\_custom\_blocks) | List of ingress rules to create with specific cidr\_blocks, prefix\_list\_ids, self, source\_security\_group\_id or ipv6\_cidr\_blocks | <pre>list(object({<br>    description              = optional(string, "Ingress Rule")<br>    from_port                = optional(number)<br>    rule                     = optional(string, "_")<br>    to_port                  = optional(number)<br>    protocol                 = optional(string)<br>    cidr_blocks              = optional(list(string))<br>    ipv6_cidr_blocks         = optional(list(string))<br>    prefix_list_ids          = optional(list(string))<br>    self                     = optional(bool)<br>    source_security_group_id = optional(string)<br>  }))</pre> | `[]` | no |
...
| <a name="input_number_of_computed_egress_with_custom_blocks"></a> [number\_of\_computed\_egress\_with\_custom\_blocks](#input\_number\_of\_computed\_egress\_with\_custom\_blocks) | Number of computed egress rules to create where cidr\_blocks, ipv6\_cidr\_blocks, prefix\_list\_ids, self or source\_security\_group\_id is defined | `number` | `0` | no |
...
| <a name="input_number_of_computed_ingress_with_custom_blocks"></a> [number\_of\_computed\_ingress\_with\_custom\_blocks](#input\_number\_of\_computed\_ingress\_with\_custom\_blocks) | Number of computed ingress rules to create where cidr\_blocks, prefix\_list\_ids, self, source\_security\_group\_id or ipv6\_cidr\_blocks is defined | `number` | `0` | no |
