...
| <a name="input_auto_ingress_rules"></a> [auto\_ingress\_rules](#input\_auto\_ingress\_rules) | List of ingress rules to add automatically | `list(string)` | <pre>[<br>  "kafka-broker-tcp",<br>  "kafka-broker-tls-tcp",<br>  "kafka-broker-sasl-scram-tcp",<br>  "kafka-broker-iam-tcp",<br>  "kafka-broker-public-iam-tcp",<br>  "zookeeper-nodes-tcp",<br>  "zookeeper-nodes-tls-tcp",<br>  "kafka-jmx-exporter-tcp",<br>  "kafka-node-exporter-tcp"<br>]</pre> | no |
